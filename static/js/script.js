...
class PomodoroApp {
  constructor() {
    ...
    // Скины убраны из пользовательской кастомизации (оставляем базовый образ)
    this.skins = [];
    ...
    this.catalog = {
      characters: [
        { id: "none", name: "Без персонажа", image: null },
        { id: "char1", name: "Персонаж 1", image: "./static/images/char1.png" },
        { id: "char2", name: "Персонаж 2", image: "./static/images/char2.png" },
        { id: "char3", name: "Персонаж 3", image: "./static/images/char3.png" },
        { id: "char4", name: "Персонаж 4", image: "./static/images/char4.png" },
        { id: "char5", name: "Персонаж 5", image: "./static/images/char5.png" },
        { id: "char6", name: "Персонаж 6", image: "./static/images/char6.png" },
        { id: "char7", name: "Персонаж 7", image: "./static/images/char7.png" },
        { id: "char8", name: "Персонаж 8", image: "./static/images/char8.png" },
        { id: "char9", name: "Персонаж 9", image: "./static/images/char9.png" },
      ],
    };
  ...
  async init() {
    ...
    // Темы отключены — ничего не восстанавливаем по скинам

    // Восстановим выбранного персонажа
    try {
    ...
    // Подготовка модалки кастомизации
  ...
  enterFocusMode() {
    ...
    // Скрываем кнопку настроек во время таймера
  ...
  exitFocusMode() {
    ...
    // Показываем кнопку настроек после остановки таймера
    const settingsBtn = document.getElementById("btn-settings");
  ...
  applyCharacterImage(forceReload = false) {
    ...
    // Вариант скина влияет на файл: добавим суффикс -<skin> если не classic
    const skinSuffix =
    ...
    // Во время таймера скрываем оверлей (оставляем только GIF)
    if (isWorking) {
      overlay.style.display = "none";
    } else {
      overlay.style.display = "block";
      // Рендер выбранного персонажа поверх базового изображения
      overlay.innerHTML = "";
  ...
  initCustomizeModal() {
    ...
    // Рендер стартовой вкладки (персонажи)
    ...
    grid.innerHTML = items
      .map((item) => {
        ...
        const thumb = item.image
          ...
          : `<div class=\"skin-thumb\" style=\"display:flex;align-items:center;justify-content:center;background:#f0f0f0;border:2px dashed #ccc;color:#999;font-size:14px;\">Нет</div>`;
        return `
          <div class=\"skin-card${
            selected ? " selected" : ""
